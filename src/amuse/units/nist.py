...
class Constants:
    ...
    def translate(self, to_translate):
        itemlist = [s[1] for s in self.translator if to_translate == s[0]]
        if itemlist == []:
            return to_translate.lstrip(' ')
        return itemlist[0].strip('\n')
    ...
    def list_constants(self):
        ...
        namestr_length = (
            len(firstline) - len(firstline[firstline.find("   "):].lstrip())
        )
        ...
        column_index_of_unit = (
            ...
            - len(
                firstline[
                    column_index_of_uncertainty+21+firstline[
                        column_index_of_uncertainty+21:
                    ].find(" "):
                ].lstrip()
            )
        )
