...
from amuse.community.interface.stopping_condition import (
    StoppingConditionInterface, StoppingConditions
)
from amuse.support.literature import LiteratureReferencesMixIn

from amuse.units import (
    generic_unit_system, nbody_system, units
)
...
class FiInterface(
    ...
    def __init__(self, mode=MODE_NORMAL, **options):
        ...
        if (
                "number_of_workers" in options
                and options["number_of_workers"] != 1
        ):
            raise Exception(
                "Fi expects number_of_workers to be 1,\n"
                "for multiple processors use mode='openmp' and set "
    ...
    def new_dm_particle():
        ...
        function.addParameter(
            'radius', dtype='d', direction=function.IN, default=0)
    ...
    def new_sph_particle():
        ...
        for x in ['mass', 'x', 'y', 'z', 'vx', 'vy', 'vz', 'u']:
            function.addParameter(x, dtype='d', direction=function.IN)
        function.addParameter(
            'h_smooth', dtype='d', direction=function.IN, default=0)
        function.result_type = 'i'
        return function
    ...
    def new_star_particle():
        ...
        for x in ['mass', 'x', 'y', 'z', 'vx', 'vy', 'vz']:
            function.addParameter(x, dtype='d', direction=function.IN)
        function.addParameter(
            'tform', dtype='d', direction=function.IN, default=0)
        function.addParameter(
            'radius', dtype='d', direction=function.IN, default=0)
        function.result_type = 'i'
        return function
    ...
    def get_kinetic_energy():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'kinetic_energy', dtype='d', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def get_potential_energy():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'potential_energy', dtype='d', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def get_thermal_energy():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'thermal_energy', dtype='d', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def get_total_energy():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'total_energy', dtype='d', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def get_number_of_particles():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'number_of_particles', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def get_hydro_state_at_point():
        ...
        for x in ['vx', 'vy', 'vz']:
            function.addParameter(
                x, dtype='d', direction=function.IN, default=0)
...
# logicals
    ...
    def set_use_hydro():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'use_hydro_flag', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_use_hydro():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'use_hydro_flag', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_radiate():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'radiation_flag', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_radiate():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'radiation_flag', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_starform():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'star_formation_flag', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_starform():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'star_formation_flag', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_acc_tstp():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'acc_timestep_flag', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_acc_tstp():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'acc_timestep_flag', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_freetstp():
        """
        set_freetstp([0,1]): use freeform (v/freev)**freevexp *
          (a/freea)**freeaexp timestep crit if 1
        """
        function = LegacyFunctionSpecification()
        function.addParameter(
    ...
    def set_directsum():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'direct_sum_flag', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_directsum():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'direct_sum_flag', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_selfgrav():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'self_gravity_flag', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_selfgrav():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'self_gravity_flag', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_fixthalo():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'fixed_halo_flag', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_fixthalo():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'fixed_halo_flag', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_adaptive_eps():
        """
        set_adaptive_eps([0,1]): use of adaptive grav smoothing for all part
          if 1
        """
        function = LegacyFunctionSpecification()
        function.addParameter(
    ...
    def set_smoothinput():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'smooth_input_flag', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_smoothinput():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'smooth_input_flag', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_consph():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'conservative_sph_flag', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def set_sphinit():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'sph_dens_init_flag', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_sphinit():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'sph_dens_init_flag', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_isotherm():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'isothermal_flag', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_isotherm():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'isothermal_flag', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_eps_is_h():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'eps_is_h_flag', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_eps_is_h():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'eps_is_h_flag', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def get_balsara():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'balsara_flag', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_mingaseps():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'mingaseps_flag', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_mingaseps():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'mingaseps_flag', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
...
# integers
    ...
    def set_firstsnap():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'first_snapshot', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_firstsnap():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'first_snapshot', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_stepout():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'output_interval', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_stepout():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'output_interval', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def get_steplog():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'log_interval', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_max_tbin():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'maximum_time_bin', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_max_tbin():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'maximum_time_bin', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_minppbin():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'minimum_part_per_bin', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_minppbin():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'minimum_part_per_bin', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
...
# real
    ...
    def set_unitm_in_msun():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'unitm_in_msun', dtype='d', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_unitm_in_msun():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'unitm_in_msun', dtype='d', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def get_unitl_in_kpc():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'unitl_in_kpc', dtype='d', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_rhomax():
        """
        Maximum density in case of star formation (force SF if exceeded,
        ignored if star formation is off)
        """
        function = LegacyFunctionSpecification()
...
# character
    ...
    def set_halofile():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'halofile', dtype='string', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_halofile():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'halofile', dtype='string', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_feedback():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'feedback', dtype='string', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_feedback():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'feedback', dtype='string', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_hupdatemethod():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'hupdatemethod', dtype='string', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_hupdatemethod():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'hupdatemethod', dtype='string', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_sph_visc():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'sph_visc', dtype='string', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_sph_visc():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'sph_visc', dtype='string', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_fi_data_directory():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'fi_data_directory', dtype='string', direction=function.IN,
    ...
    def get_fi_data_directory():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'fi_data_directory', dtype='string', direction=function.OUT,
            description="Name of the Fi data directory")
        function.result_type = 'int32'
        function.result_doc = """
        0 - OK
    ...
    def get_id_of_removed_sph_particle():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'index_of_delete', dtype='int32', direction=function.IN,
...
class GlFiInterface(FiInterface):
    ...
    def get_upvector():
        """
        specify the orientation of the image by setting the direction vector of
        image y
        """
        function = LegacyFunctionSpecification()
        function.addParameter(
            'x', dtype='d', direction=function.OUT, unit=units.none)
        function.addParameter(
            'y', dtype='d', direction=function.OUT, unit=units.none)
        function.addParameter(
            'z', dtype='d', direction=function.OUT, unit=units.none)
        function.result_type = 'i'
        return function
...
class Fi(GravitationalDynamics, GravityFieldCode):
    ...
    def __init__(
            self, convert_nbody=None, mode='normal', use_gl=False, **options):
        if(use_gl):
    ...
    def define_parameters(self, object):
        ...
        object.add_boolean_parameter(
            ...
            "set_radiate",
            "radiation_flag",
            "Radiation flag. True means: radiation (i.e. radiative "
            "cooling/heating) is included. "
        ...
        object.add_boolean_parameter(
            ...
            "set_use_hydro",
            "use_hydro_flag",
            "Hydrodynamics flag. True means: SPH hydro included, False means: "
            "gravity only.",
            True
        )
        ...
        object.add_boolean_parameter(
            ...
            "set_acc_tstp",
            "acc_timestep_flag",
            "Acceleration-timestep flag. True means: use vref/acc timestep"
            " criterion.",
            True
        )
        ...
        object.add_boolean_parameter(
            ...
            "Freeform-timestep flag. True means: use freeform"
            " (v/freev)**freevexp * (a/freea)**freeaexp timestep criterion.",
            False
        )
        ...
        object.add_boolean_parameter(
            ...
            "Quadrupole-moments flag. True means: calculate and use quadrupole"
            " cell moments.",
            False
        )
        ...
        object.add_boolean_parameter(
            ...
            "set_directsum",
            "direct_sum_flag",
            "Direct-summation flag. True means: direct N**2 gravity"
            " summation.",
            False
        )
        ...
        object.add_boolean_parameter(
            ...
            "set_selfgrav",
            "self_gravity_flag",
            "Self-gravity flag. False means: self-gravity is not used, only"
            " external potentials.",
            True
        )
        ...
        object.add_boolean_parameter(
            ...
            "Adaptive-smoothing flag. True means: use of adaptive gravity"
            " smoothing for all particles.",
            False
        )
        ...
        object.add_boolean_parameter(
            ...
            "Gadget-cell-opening flag. True means: use of Gadget cell"
            " opening criterion.",
            True
        )
        ...
        object.add_boolean_parameter(
            ...
            "Conservative-SPH flag. True means: use Springel & Hernquist"
            " conservative SPH form (currently the only option).",
            True
        )
        ...
        object.add_boolean_parameter(
            ...
            "set_sphinit",
            "sph_dens_init_flag",
            "SPH-density-init flag. True means: initialize sph density and"
            " h_smooth (most probably useless for AMUSE interface).",
            True
        )
        ...
        object.add_boolean_parameter(
            ...
            "Integrate-entropy flag. True means: integrate entropy, else:"
            " internal energy.",
            True
        )
        ...
        object.add_boolean_parameter(
            ...
            "set_eps_is_h",
            "eps_is_h_flag",
            "Eps-is-h flag. True means: set gas particles gravitational"
            " epsilon to h (SPH smoothing length).",
            True
        )
        ...
        object.add_method_parameter(
            ...
            "set_targetnn",
            "targetnn",
            "The target number of neighbour particles for variable"
            " gravitational eps.",
            default_value=32
        )
        ...
        object.add_method_parameter(
            ...
            "set_pboxsize",
            "periodic_box_size",
            "The size of simulation domain box (particles outside get"
            " deleted).",
        ...
        object.add_method_parameter(
            ...
            "Acceleration-timestep criterion constant (unitless,"
            " standard=0.25).",
            default_value=0.25
        )
        ...
        object.add_method_parameter(
            ...
            "set_crionrate",
            "zeta_cr_ion_rate",
            "primary cosmic ray ionization rate, zeta (in units of 1.8e-17"
            " sec^-1, 1.)",
        ...
        object.add_method_parameter(
            ...
            "set_halofile",
            "halofile",
            "Path to initial halo model file, relative to the Fi data"
            " directory (none)",
            default_value="none"
        )
        ...
        object.add_boolean_parameter(
            ...
            "Periodic boundaries flag. True means: use periodic boundary"
    ...
    def define_methods(self, object):
        ...
        object.add_method(
            ...
            (nbody_system.density, nbody_system.momentum_density,
             ...
             nbody_system.energy_density, object.ERROR_CODE)
        )
    ...
    def update_particle_set(self):
        ...
        number_of_removed_particles = \
            self.get_number_of_sph_particles_removed()

        if number_of_removed_particles == 0:
            return

        indices_in_update_list = range(number_of_removed_particles)
        indices_to_remove = self.get_id_of_removed_sph_particle(
            indices_in_update_list)

        incode_storage = \
            self.gas_particles._remove_indices_in_attribute_storage(
                indices_to_remove)
...
class FiViewer(Fi):
    ...
    def __init__(self, convert_nbody=None, mode='normal', **options):
        Fi.__init__(
            self, convert_nbody=convert_nbody, mode=mode, use_gl=True,
            **options)
...
class FiMapInterface(CodeInterface):
    ...
    def new_particle():
        ...
        for x in ['x', 'y', 'z']:
            function.addParameter(x, dtype='d', direction=function.IN)
        function.addParameter(
            'weight', dtype='d', direction=function.IN, default=1.)
        function.addParameter(
            'radius', dtype='d', direction=function.IN, default=0.)
        function.addParameter(
            'opacity_area', dtype='d', direction=function.IN, default=0.)
        function.addParameter(
            'index', dtype='i', direction=function.IN, default=-1)
        function.result_type = 'i'
        return function
    ...
    def get_state():
        ...
        function.addParameter('radius', dtype='d', direction=function.OUT)
        function.addParameter(
            'opacity_area', dtype='d', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_extinction_flag():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'extinction_flag', dtype='i', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_extinction_flag():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'extinction_flag', dtype='i', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_minimum_distance():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'minimum_distance', dtype='d', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_minimum_distance():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'minimum_distance', dtype='d', direction=function.OUT)
        function.result_type = 'i'
        return function
    ...
    def set_projection_mode():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'projection_mode', dtype='string', direction=function.IN)
        function.result_type = 'i'
        return function
    ...
    def get_projection_mode():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'projection_mode', dtype='string', direction=function.OUT)
        function.result_type = 'i'
        return function
...
class FiMap(CommonCode):
    ...
    def define_parameters(self, object):
        ...
        object.add_vector_parameter(
            ...
            (
                "projection_direction_x", "projection_direction_y",
                "projection_direction_z"
            )
        )
