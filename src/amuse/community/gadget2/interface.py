...
from amuse.units import (
    units, generic_unit_system, nbody_system,
)
...
class Gadget2Interface(
    ...
    def get_alpha_visc():
        ...
        function.must_handle_array = True
        function.addParameter(
            'index_of_the_particle', dtype='int32', direction=function.IN, description="alpha_SPH, the artificial viscosity of a particle"
        )
...
# setting/ getting parameters
    ...
    def get_epsilon():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'epsilon', dtype='float64', direction=function.OUT,
    ...
    def set_epsilon():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'epsilon', dtype='float64', direction=function.IN,
            description="epsilon, a softening parameter for gravitational potentials with point particles"
        )
        function.result_type = 'int32'
        return function
    ...
    def get_gadget_output_directory():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'gadget_output_directory', dtype='string', direction=function.OUT,
    ...
    def get_viscosity_switch():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'viscosity_switch', dtype='string', direction=function.OUT,
    ...
    def set_gadget_output_directory():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'gadget_output_directory', dtype='string', direction=function.IN,
            description="The path to the Gadget-2 OutputDir."
        )
        function.result_type = 'int32'
        return function
    ...
    def get_unit_mass():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'code_mass_unit', dtype='float64', direction=function.OUT,
    ...
    def set_unit_mass():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'code_mass_unit', dtype='float64', direction=function.IN,
            description="The code mass unit (in g/h, default: 1.989e43 g = 10^10 MSun)."
        )
        function.result_type = 'int32'
        return function
    ...
    def get_unit_length():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'code_length_unit', dtype='float64', direction=function.OUT,
    ...
    def set_unit_length():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'code_length_unit', dtype='float64', direction=function.IN,
            description="The code length unit (in cm/h, default: 3.085678e21 cm = 1 kpc)."
        )
        function.result_type = 'int32'
        return function
    ...
    def get_unit_time():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'code_time_unit', dtype='float64', direction=function.OUT,
    ...
    def set_unit_time():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'code_time_unit', dtype='float64', direction=function.IN,
            description="The code time unit (in s/h, default: 3.085678e16 s = (1 kpc) / (1 km/s) ~ 0.9778 Gyr)."
        )
        function.result_type = 'int32'
        return function
    ...
    def get_unit_velocity():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'code_velocity_unit', dtype='float64', direction=function.OUT,
    ...
    def set_unit_velocity():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter(
            'code_velocity_unit', dtype='float64', direction=function.IN,
            description="The code velocity unit (in s/h, default: 3.085678e16 s = (1 kpc) / (1 km/s) ~ 0.9778 Gyr)."
        )
        function.result_type = 'int32'
        return function
    ...
    def get_energy_file():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'energy_file', dtype='string', direction=function.OUT,
    ...
    def set_energy_file():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'energy_file', dtype='string', direction=function.IN,
            description="The path to the Gadget-2 energy statistics output file."
        )
        function.result_type = 'int32'
        return function
    ...
    def get_info_file():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'info_file', dtype='string', direction=function.OUT,
    ...
    def set_info_file():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'info_file', dtype='string', direction=function.IN,
            description="The path to the Gadget-2 info output file."
        )
        function.result_type = 'int32'
        return function
    ...
    def get_timings_file():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'timings_file', dtype='string', direction=function.OUT,
    ...
    def set_timings_file():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'timings_file', dtype='string', direction=function.IN,
            description="The path to the Gadget-2 timings output file."
        )
        function.result_type = 'int32'
        return function
    ...
    def get_cpu_file():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'cpu_file', dtype='string', direction=function.OUT,
    ...
    def set_cpu_file():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'cpu_file', dtype='string', direction=function.IN,
            description="The path to the Gadget-2 cpu statistics output file."
        )
        function.result_type = 'int32'
        return function
    ...
    def get_time_limit_cpu():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'time_limit_cpu', dtype='d', direction=function.OUT,
    ...
    def set_time_limit_cpu():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'time_limit_cpu', dtype='d', direction=function.IN,
            description="The cpu-time limit. Gadget2 will stop once 85% of this (wall-clock) time has passed."
        )
        function.result_type = 'i'
        return function
    ...
    def get_comoving_integration_flag():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'comoving_integration_flag', dtype='bool', direction=function.OUT,
    ...
    def set_comoving_integration_flag():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'comoving_integration_flag', dtype='bool', direction=function.IN,
            description="Flag to do a cosmological run with comoving coordinates.")
        function.result_type = 'i'
        return function
    ...
    def get_type_of_timestep_criterion():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'type_of_timestep_criterion', dtype='i', direction=function.OUT,
    ...
    def set_type_of_timestep_criterion():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'type_of_timestep_criterion', dtype='i', direction=function.IN,
            description="Timestep criterion to use. Can only be zero: timestep proportional to acceleration^-0.5")
        function.result_type = 'i'
        return function
    ...
    def get_time_max():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'time_max', dtype='d', direction=function.OUT,
    ...
    def set_time_max():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'time_max', dtype='d', direction=function.IN,
            description="The time at the end of the run.")
        function.result_type = 'i'
        return function
    ...
    def evolve_to_redshift():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'redshift', dtype='d', direction=function.IN,
    ...
    def get_redshift():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'redshift', dtype='d', direction=function.OUT,
    ...
    def get_redshift_begin():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'redshift_begin', dtype='d', direction=function.OUT,
    ...
    def set_redshift_begin():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'redshift_begin', dtype='d', direction=function.IN,
            description="The redshift at the start of the run.")
        function.result_type = 'i'
        return function
    ...
    def get_redshift_max():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'redshift_max', dtype='d', direction=function.OUT,
    ...
    def set_redshift_max():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'redshift_max', dtype='d', direction=function.IN,
            description="The redshift at the end of the run.")
        function.result_type = 'i'
        return function
    ...
    def get_omega_zero():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'omega_zero', dtype='d', direction=function.OUT,
    ...
    def set_omega_zero():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'omega_zero', dtype='d', direction=function.IN,
            description="Cosmological matter density parameter in units of the critical density at z=0.")
        function.result_type = 'i'
        return function
    ...
    def get_omega_lambda():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'omega_lambda', dtype='d', direction=function.OUT,
    ...
    def set_omega_lambda():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'omega_lambda', dtype='d', direction=function.IN,
            description="Cosmological vacuum energy density parameter in units of the critical density at z=0.")
        function.result_type = 'i'
        return function
    ...
    def get_omega_baryon():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'omega_baryon', dtype='d', direction=function.OUT,
    ...
    def set_omega_baryon():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'omega_baryon', dtype='d', direction=function.IN,
            description="Cosmological baryonic density parameter in units of the critical density at z=0.")
        function.result_type = 'i'
        return function
    ...
    def get_hubble_param():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'hubble_param', dtype='d', direction=function.OUT,
    ...
    def set_hubble_param():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'hubble_param', dtype='d', direction=function.IN,
            description="The cosmological Hubble parameter.")
        function.result_type = 'i'
        return function
    ...
    def get_err_tol_int_accuracy():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'err_tol_int_accuracy', dtype='d', direction=function.OUT,
    ...
    def set_err_tol_int_accuracy():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'err_tol_int_accuracy', dtype='d', direction=function.IN,
            description="Accuracy parameter used in timestep criterion. Actual timesteps are proportional to err_tol_int_accuracy^0.5")
        function.result_type = 'i'
        return function
    ...
    def get_max_size_timestep():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'max_size_timestep', dtype='d', direction=function.OUT,
    ...
    def set_max_size_timestep():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'max_size_timestep', dtype='d', direction=function.IN,
            description="The maximum size of the timestep a particle may take.")
        function.result_type = 'i'
        return function
    ...
    def get_min_size_timestep():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'min_size_timestep', dtype='d', direction=function.OUT,
    ...
    def set_min_size_timestep():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'min_size_timestep', dtype='d', direction=function.IN,
            description="The minimum size of the timestep a particle may take.")
        function.result_type = 'i'
        return function
    ...
    def get_tree_domain_update_frequency():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'tree_domain_update_frequency', dtype='d', direction=function.OUT,
    ...
    def set_tree_domain_update_frequency():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'tree_domain_update_frequency', dtype='d', direction=function.IN,
            description="The frequency with which the tree and domain decomposition are fully updated, in terms of (# force computations / # particles).")
        function.result_type = 'i'
        return function
    ...
    def get_time_between_statistics():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'time_between_statistics', dtype='d', direction=function.OUT,
    ...
    def set_time_between_statistics():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'time_between_statistics', dtype='d', direction=function.IN,
            description="The time between statistics output written to the output files.")
        function.result_type = 'i'
        return function
    ...
    def get_min_gas_temp():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'min_gas_temp', dtype='d', direction=function.OUT,
    ...
    def set_min_gas_temp():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'min_gas_temp', dtype='d', direction=function.IN,
            description="The minimum temperature of gas particles.")
        function.result_type = 'i'
        return function
    ...
    def get_min_gas_hsmooth_fractional():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'min_gas_hsmooth_fractional', dtype='d', direction=function.OUT,
    ...
    def set_min_gas_hsmooth_fractional():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'min_gas_hsmooth_fractional', dtype='d', direction=function.IN,
            description="The minimum smoothing length of gas particles relative to their softening lengths.")
        function.result_type = 'i'
        return function
    ...
    def get_softening_gas_max_phys():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'softening_gas_max_phys', dtype='d', direction=function.OUT,
    ...
    def set_softening_gas_max_phys():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'softening_gas_max_phys', dtype='d', direction=function.IN,
            description="The maximum physical softening of gas particles for comoving integrations.")
        function.result_type = 'i'
        return function
    ...
    def get_softening_halo_max_phys():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'softening_halo_max_phys', dtype='d', direction=function.OUT,
    ...
    def set_softening_halo_max_phys():
        function = LegacyFunctionSpecification()
        function.addParameter(
            'softening_halo_max_phys', dtype='d', direction=function.IN,
            description="The maximum physical softening of dm particles for comoving integrations.")
        function.result_type = 'i'
        return function
...
class Gadget2(GravitationalDynamics, GravityFieldCode):
    ...
    def define_particle_sets(self, object):
        object.define_super_set(
            'particles', ['dm_particles', 'gas_particles'],
    ...
    def define_methods(self, object):
        ...
        object.add_method(
            ...
            (
                ...
                generic_unit_system.length, generic_unit_system.speed,
                generic_unit_system.speed, generic_unit_system.speed
            ),
            (
                generic_unit_system.density,
                generic_unit_system.momentum_density,
                generic_unit_system.momentum_density,
                generic_unit_system.momentum_density,
                generic_unit_system.energy_density, object.ERROR_CODE
            )
        )
        ...
        object.add_method(
            ...
            (
                generic_unit_system.speed, generic_unit_system.speed,
                generic_unit_system.speed, object.ERROR_CODE,
            )
        )
