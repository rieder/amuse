...
class GalactICsImplementation(object):
    ...
    def __init__(self):
        ...
        self._bin_path = os.path.join(
            os.path.dirname(os.path.abspath(__file__)), "src", "bin"
        )
    ...
    def get_generate_halo_flag(self, value):
        value.value = self._generate_halo_flag
        return 0

    def set_generate_halo_flag(self, value):
        self._generate_halo_flag = value
        return 0

    def get_halo_outer_radius(self, value):
        value.value = self._halo_outer_radius
        return 0

    def set_halo_outer_radius(self, value):
        self._halo_outer_radius = value
        return 0

    def get_scale_velocity(self, value):
        value.value = self._scale_velocity
        return 0

    def set_scale_velocity(self, value):
        self._scale_velocity = value
        return 0

    def get_scale_radius(self, value):
        value.value = self._scale_radius
        return 0

    def set_scale_radius(self, value):
        self._scale_radius = value
        return 0

    def get_truncation_delta_r(self, value):
        value.value = self._truncation_delta_r
        return 0

    def set_truncation_delta_r(self, value):
        self._truncation_delta_r = value
        return 0

    def get_inner_cusp_slope(self, value):
        value.value = self._inner_cusp_slope
        return 0

    def set_inner_cusp_slope(self, value):
        self._inner_cusp_slope = value
        return 0

    def get_outer_slope(self, value):
        value.value = self._outer_slope
        return 0

    def set_outer_slope(self, value):
        self._outer_slope = value
        return 0

    def get_generate_disk_flag(self, value):
        value.value = self._generate_disk_flag
        return 0

    def set_generate_disk_flag(self, value):
        self._generate_disk_flag = value
        return 0

    def get_disk_mass(self, value):
        value.value = self._disk_mass
        return 0

    def set_disk_mass(self, value):
        self._disk_mass = value
        return 0

    def get_disk_scale_length(self, value):
        value.value = self._disk_scale_length
        return 0

    def set_disk_scale_length(self, value):
        self._disk_scale_length = value
        return 0

    def get_disk_outer_radius(self, value):
        value.value = self._disk_outer_radius
        return 0

    def set_disk_outer_radius(self, value):
        self._disk_outer_radius = value
        return 0

    def get_disk_scale_height_sech2(self, value):
        value.value = self._disk_scale_height_sech2
        return 0

    def set_disk_scale_height_sech2(self, value):
        self._disk_scale_height_sech2 = value
        return 0

    def get_disk_truncation_dr(self, value):
        value.value = self._disk_truncation_dr
        return 0

    def set_disk_truncation_dr(self, value):
        self._disk_truncation_dr = value
        return 0

    def get_generate_bulge_flag(self, value):
        value.value = self._generate_bulge_flag
        return 0

    def set_generate_bulge_flag(self, value):
        self._generate_bulge_flag = value
        return 0

    def get_Sersic_index_n(self, value):
        value.value = self._Sersic_index_n
        return 0

    def set_Sersic_index_n(self, value):
        self._Sersic_index_n = value
        return 0

    def get_bulge_velocity(self, value):
        value.value = self._bulge_velocity
        return 0

    def set_bulge_velocity(self, value):
        self._bulge_velocity = value
        return 0

    def get_bulge_scale_radius(self, value):
        value.value = self._bulge_scale_radius
        return 0

    def set_bulge_scale_radius(self, value):
        self._bulge_scale_radius = value
        return 0

    def get_radial_grid_delta_r(self, value):
        value.value = self._radial_grid_delta_r
        return 0

    def set_radial_grid_delta_r(self, value):
        self._radial_grid_delta_r = value
        return 0

    def get_number_of_grid_intervals(self, value):
        value.value = self._number_of_grid_intervals
        return 0

    def set_number_of_grid_intervals(self, value):
        self._number_of_grid_intervals = value
        return 0

    def get_order_of_multipole_expansion(self, value):
        value.value = self._order_of_multipole_expansion
        return 0

    def set_order_of_multipole_expansion(self, value):
        self._order_of_multipole_expansion = value
        return 0

    def get_central_radial_vel_dispersion(self, value):
        value.value = self._central_radial_vel_dispersion
        return 0

    def set_central_radial_vel_dispersion(self, value):
        self._central_radial_vel_dispersion = value
        return 0

    def get_scale_length_of_sigR2(self, value):
        value.value = self._scale_length_of_sigR2
        return 0

    def set_scale_length_of_sigR2(self, value):
        self._scale_length_of_sigR2 = value
        return 0

    def get_number_of_radial_steps_correction_fns(self, value):
        value.value = self._number_of_radial_steps_correction_fns
        return 0

    def set_number_of_radial_steps_correction_fns(self, value):
        self._number_of_radial_steps_correction_fns = value
        return 0

    def get_number_of_iterations(self, value):
        value.value = self._number_of_iterations
        return 0
    ...
    def get_halo_streaming_fraction(self, value):
        value.value = self._halo_streaming_fraction
        return 0

    def set_halo_streaming_fraction(self, value):
        self._halo_streaming_fraction = value
        return 0

    def get_halo_number_of_particles(self, value):
        value.value = self._halo_number_of_particles
        return 0

    def set_halo_number_of_particles(self, value):
        self._halo_number_of_particles = value
        return 0

    def get_halo_random_seed(self, value):
        value.value = self._halo_random_seed
        return 0

    def set_halo_random_seed(self, value):
        self._halo_random_seed = value
        return 0

    def get_halo_do_center_flag(self, value):
        value.value = self._halo_do_center_flag
        return 0

    def set_halo_do_center_flag(self, value):
        self._halo_do_center_flag = value
        return 0

    def get_bulge_streaming_fraction(self, value):
        value.value = self._bulge_streaming_fraction
        return 0

    def set_bulge_streaming_fraction(self, value):
        self._bulge_streaming_fraction = value
        return 0

    def get_bulge_number_of_particles(self, value):
        value.value = self._bulge_number_of_particles
        return 0

    def set_bulge_number_of_particles(self, value):
        self._bulge_number_of_particles = value
        return 0

    def get_bulge_random_seed(self, value):
        value.value = self._bulge_random_seed
        return 0

    def set_bulge_random_seed(self, value):
        self._bulge_random_seed = value
        return 0

    def get_bulge_do_center_flag(self, value):
        value.value = self._bulge_do_center_flag
        return 0

    def set_bulge_do_center_flag(self, value):
        self._bulge_do_center_flag = value
        return 0

    def get_disk_number_of_particles(self, value):
        value.value = self._disk_number_of_particles
        return 0

    def set_disk_number_of_particles(self, value):
        self._disk_number_of_particles = value
        return 0

    def get_disk_random_seed(self, value):
        value.value = self._disk_random_seed
        return 0

    def set_disk_random_seed(self, value):
        self._disk_random_seed = value
        return 0

    def get_disk_do_center_flag(self, value):
        value.value = self._disk_do_center_flag
        return 0

    def set_disk_do_center_flag(self, value):
        self._disk_do_center_flag = value
        return 0
    ...
    def _directory_contains_valid_model(self, data_directory):
        if (
                ...
                and os.path.exists(os.path.join(data_directory, 'getfreqs.finished'))
                and (
    ...
    def commit_parameters(self):
        try:
            ...
            proc = Popen(
                [os.path.join(self._bin_path, "dbh")],
            ...
            proc = Popen(
                [os.path.join(self._bin_path, "getfreqs")],
                cwd=self._cwd, stdin=PIPE, stdout=PIPE, stderr=PIPE
            )
            ...
            if self._generate_disk_flag:
                proc = Popen(
                    [os.path.join(self._bin_path, "diskdf")],
                    cwd=self._cwd, stdin=PIPE, stdout=PIPE, stderr=PIPE
                )
...
class GalactICsInterface(
        PythonCodeInterface, CommonCodeInterface, LiteratureReferencesMixIn,
        CodeWithDataDirectories):
    """
    ...
    # integer parameters
    @legacy_function
    def get_number_of_grid_intervals():
        function = LegacyFunctionSpecification()
    ...
    @legacy_function
    def set_number_of_grid_intervals():
        function = LegacyFunctionSpecification()
    ...
    @legacy_function
    def get_order_of_multipole_expansion():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='int32', direction=function.OUT)
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def set_order_of_multipole_expansion():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='int32', direction=function.IN)
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def get_number_of_radial_steps_correction_fns():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='int32', direction=function.OUT)
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def set_number_of_radial_steps_correction_fns():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='int32', direction=function.IN)
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def get_halo_number_of_particles():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='int32', direction=function.OUT)
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def set_halo_number_of_particles():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='int32', direction=function.IN)
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def get_bulge_number_of_particles():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='int32', direction=function.OUT)
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def set_bulge_number_of_particles():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='int32', direction=function.IN)
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def get_disk_number_of_particles():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='int32', direction=function.OUT)
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def set_disk_number_of_particles():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='int32', direction=function.IN)
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def get_disk_scale_height_sech2():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='float64', direction=function.OUT)
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def set_disk_scale_height_sech2():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='float64', direction=function.IN)
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def get_central_radial_vel_dispersion():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='float64', direction=function.OUT)
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def set_central_radial_vel_dispersion():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='float64', direction=function.IN)
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def get_halo_streaming_fraction():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='float64', direction=function.OUT)
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def set_halo_streaming_fraction():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='float64', direction=function.IN)
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def get_bulge_streaming_fraction():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='float64', direction=function.OUT)
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def set_bulge_streaming_fraction():
        function = LegacyFunctionSpecification()
        function.addParameter('value', dtype='float64', direction=function.IN)
        function.result_type = 'int32'
        return function
