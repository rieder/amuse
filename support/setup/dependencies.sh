...
DEPS_macports="${DEPS_macports} zlib"
...
DEPS_homebrew="${DEPS_homebrew} lapack zlib"
...
DEPS_apt="${DEPS_apt} libhealpix-cxx-dev liblapack-dev libblas-dev zlib1g-dev"
...
DEPS_dnf="${DEPS_dnf} libqhull-devel blas-devel lapack-devel zlib-devel"

# Note: Fedora 40 has replaced zlib-devel with zlib-ng-compat-devel. RHEL is still on
# the old name. We should probably switch at some point.
